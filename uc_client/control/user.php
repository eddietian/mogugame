...
class usercontrol extends base {
	...
	function onregister() {
		...
		// 	return $status;
		// }
		$uid = $_ENV['user']->add_user($username, $password,$email,$promote_id,$promote_account,$game_id,$game_name,$version, 0, $questionid, $answer, $regip,$platform);
		return $uid;
	}
	...
	function onget_user_by_username($username){
		$this->init_input();
		$user = $_ENV['user']->get_user_by_username($username);
		return $user;
	}
	function onget_user_by_uid($uid){
		$this->init_input();
