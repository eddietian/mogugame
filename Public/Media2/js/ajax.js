...
var C9377 = {
	url: 'http://www.9377.cn',
	app_url: 'http://wvw.9377.cn',
	resource: 'http://statics.9377s.com',
	build: ''
};
...
C9377.setcookie = function( name, value, expires ) {
	setcookie(name, value, expires, '/', '9377.cn');
};
	...
	if($_COOKIE['admin_url']){
		function _data_url(_this, action){
			...
			var param = ajax_parameters({
				...
				domain: m && m[1] ? m[1] : ($_GET['domain'] ? $_GET['domain'] : 's9377.com'),
